...
const view = {
    render: function(dataTemp, dataRainfall){
        ...
        // Display the content
        document.querySelector("#todayNightWeather").style.opacity = "1";
        document.querySelector("#tomorrowDayWeather").style.opacity = "1";
    
        // Weather Icon
        document.querySelector("#todayNightWeatherIcon").src = nightWeatherList[dataTemp.records.location[0].weatherElement[0].time[1].parameter.parameterName];
        document.querySelector("#todayDayWeatherIcon").src = dayWeatherList[dataTemp.records.location[0].weatherElement[0].time[2].parameter.parameterName];
        
        // Temperature
        document.querySelector("#todayNightWeatherTemp").textContent = dataTemp.records.location[0].weatherElement[2].time[1].parameter.parameterName + " °C - " + dataTemp.records.location[0].weatherElement[4].time[1].parameter.parameterName + " °C";
        document.querySelector("#tomorrowDayWeatherTemp").textContent = dataTemp.records.location[0].weatherElement[2].time[2].parameter.parameterName + " °C - " + dataTemp.records.location[0].weatherElement[4].time[2].parameter.parameterName + " °C";
    
        // Rainfall
        document.querySelector("#todayNightRainfallRate").textContent = dataRainfall.records.location[4].weatherElement[6].elementValue + " mm";
